          ...
          <div className="flex flex-col justify-center space-y-4">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                ...
                ni el sabor. Nuestro equipo de expertos trabajó incansablemente
                para desarrollar una fórmula perfecta que utilizara solo
                ingredientes naturales de la más alta calidad.
              </p>
              <p>
                Hoy, La Breve se ha convertido en la opción preferida para
                quienes buscan una bebida refrescante, saludable y deliciosa que
                se adapte a su estilo de vida activo.
              </p>
            </div>
          </div>

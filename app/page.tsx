                  ...
                  <div className="flex flex-col justify-center space-y-4">
                    <div className="space-y-2">
                      ...
                      <p className="text-la-breve-navy text-xl">
                        Bebida lista para tomar, perfecta para cualquier momento
                        del día
                      </p>
                    </div>
                  ...
                  <div className="flex flex-col justify-center space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-la-breve-navy">
                        Elaborado con ingredientes 100% naturales, sin
                ...
                <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-3">
                  ...
                  <div className="rounded-lg border bg-card p-6 text-card-foreground shadow">
                    <div className="flex flex-col space-y-4">
                      ...
                      <p className="text-la-breve-navy">
                        Perfecto para después de entrenar. Refrescante, natural
                        y con el balance perfecto de sabor.
                      </p>
                    </div>
                  </div>
                  <div className="rounded-lg border bg-card p-6 text-card-foreground shadow">
                    <div className="flex flex-col space-y-4">
                      ...
                      <p className="text-la-breve-navy">
                        Como profesional de la gastronomía, aprecio la calidad
                        de los ingredientes. La Breve es simplemente
                        excepcional.
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                  <div className="space-y-2 mb-6">
                    ...
                    <p className="max-w-[600px] text-white md:text-xl">
                      Descubre nuestra variedad de productos y encuentra tu
                      favorito
                    </p>
                  </div>
                  <div className="flex flex-col gap-2 min-[400px]:flex-row">
